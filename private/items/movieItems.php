      ...
      <!-- ### Create Panels ### -->
        ...
        <div class="container">
          <div class="row">
              ...
              <?php
              $command = $conn->query('SELECT item.item_name, item.item_price, item_type.item_type_name FROm item RIGHT JOIN item_type ON item.item_type_id = item_type.item_type_id WHERE item_type.item_type_name="Movie";');
              $command->execute();
